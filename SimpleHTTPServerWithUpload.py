...
class SimpleHTTPRequestHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        f.write(b'* {font-family: Helvetica; font-size: 12px; }\n')
        ...
        f.write(
            b"<a href=\"https://gist.github.com/UniIsland/3346170\" target=\"_blank\">")
    ...
    def list_directory(self, path):
        ...
        f.write(b'<style type="text/css">\n')
        f.write(b'* {font-family: Helvetica; font-size: 14px; }\n')
        f.write(b'a { text-decoration: none; }\n')
        f.write(
